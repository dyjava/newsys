...
public class DateChooserJTextField extends JTextField {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3872153840716565101L;
...
//    }
    ...
    private class DateChooser extends JPanel implements ActionListener, ChangeListener {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -4119849694001138880L;
        ...
        void showDateChooser(Point position) {
            Frame owner = (Frame) SwingUtilities.getWindowAncestor(DateChooserJTextField.this);
    ...
    public static void main(String[] args) {
        ...
        mainFrame.add(new DateChooserJTextField());
